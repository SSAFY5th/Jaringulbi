<template>
  <div>
    <div id="font">
      <div class="regist">
        <h1 class="underline top1">지출 수정</h1>
        <hr />
        <div>
        ...
        <div class="regist_form">
          ...
          <button class="btn" id="btn_group" @click="modifyAccountBook">
            등록
          </button>
          <button class="btn" id="btn_group" @click="deleteAccountBook">
            삭제
          </button>
        </div>
      </div>
...
export default {
  ...
  data() {
    ...
    if (mon < 10) mon = "0" + Number(mon + 1);
    const full1 = year + "-" + mon + "-" + this.$route.query.day;
    console.log("가계부 날짜 : " + full1);
    return {
      date: "",
      price: "",
      category: "",
  ...
  methods: {
    ...
    // deleteAccountBook() {
    //   http.delete("/accountbook/detail");
    // },
    eat() {
      this.category = "식비";
      this.categorynum = 1;
