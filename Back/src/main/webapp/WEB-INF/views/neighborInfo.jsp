                            ...
                            <div id="demo" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="${root}/img/shop1.jpg" alt="Los Angeles" width="100%" height="400em">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="${root}/img/shop2.jpg" alt="Los Angeles" width="100%" height="400em">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="${root}/img/shop3.jpg" alt="Los Angeles" width="100%" height="400em">
                                    </div>
                                </div>
