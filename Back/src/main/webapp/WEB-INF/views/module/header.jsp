  ...
  z-index: 999;">
    ...
    <div class="row">
      ...
      <nav class="navbar navbar-expand-sm" style="margin: 0 auto;">
        <div class="container">
          <a class="nav-link" href="${root}/main/mvIntroduce" style="color: #28a745">소개</a>
          <a class="nav-link" href="${root}/notice/list">공지사항</a>
          <a class="nav-link" href="${root}/main/mvNeighborInfo">동네 업종정보</a>
          <a class="nav-link" href="${root}/main/mvEnvironmentInfo">대기오염 정보</a>
        </div>
      </nav>
    </div>
  </div>
