...
<script type="text/javascript">
	function login() {
		...
		document.getElementById("loginForm").action = path + "/member/login";
        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<!-- Modal body -->
                    ...
                    <div class="form-group">
                        <label for="loginpass">Password (* 20자 이내)</label>
                        <input type="password" class="form-control"  id="loginpass" name="passwd"
                            required>
                    </div>
                </div>
