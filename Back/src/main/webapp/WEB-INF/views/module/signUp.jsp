...
<script type="text/javascript">
	function regist() {
		...
		document.getElementById("registFom").action = path + "/member/regist";
    ...
    function getPostCode() {
        new daum.Postcode({
            oncomplete: function(data) {
            	document.getElementById("interarea").value = data.address;
                document.getElementById("interdongcode").value = data.bcode;
            }
        }).open();
    }
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <button onclick="getPostCode()">지역 검색</button>
                        <input type="text" class="form-control" id="interarea" name="interarea" disabled>
                        <input type="text" id="interdongcode" value="abc" hidden/>
                    </div>
                    <div class="form-group">
