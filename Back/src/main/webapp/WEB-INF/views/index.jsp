...
<body>
                ...
                <div id="demo" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="${root}/img/home1.jpg" alt="Los Angeles" width="100%" height="400em">
                        </div>
                        <div class="carousel-item">
                            <img src="${root}/img/home2.png" alt="Los Angeles" width="100%" height="400em">
                        </div>
                        <div class="carousel-item">
                            <img src="${root}/img/home3.jpg" alt="Los Angeles" width="100%" height="400em">
                        </div>
                    </div>
    ...
    <div class="container" style="height:500px;">
        <div onclick="location.href='${root}/aptDeal/list'" class="img2 float-left mt-5 mr-3 ml-5"
            style="width:300px; height:300px; cursor: pointer;">
            <div style="width:100%; height:80%;"></div>
            <button type="button" onclick="location.href='${root}/aptDeal/list'" class="btn btn-light"
